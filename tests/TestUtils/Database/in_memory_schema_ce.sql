...
) ENGINE=MEMORY COMMENT='Shows which users has accepted shop terms';
...
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between article and its accessory articles';
...
CREATE TABLE `oxactions` (
  ...
  `OXLONGDESC` varchar(2048) NOT NULL COMMENT 'Long description, used for promotion (multilanguage)',
  `OXLONGDESC_1` varchar(2048) NOT NULL,
  `OXLONGDESC_2` varchar(2048) NOT NULL,
  `OXLONGDESC_3` varchar(2048) NOT NULL,
...
) ENGINE=MEMORY COMMENT 'Stores information about actions, promotions and banners';
...
CREATE TABLE `oxactions2article` (
  ...
  KEY `OXARTID` (`OXARTID`)
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between actions and articles';
...
CREATE TABLE `oxadminlog` (
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  `OXUSERID` char(32) character set latin1 collate latin1_general_ci NOT NULL default '' COMMENT 'User id (oxuser)',
  `OXSQL` varchar(2048) NOT NULL COMMENT 'Logged sql'
) ENGINE=MEMORY COMMENT 'Logs admin actions';
...
CREATE TABLE `oxartextends` (
  ...
  `OXLONGDESC` varchar(2048) NOT NULL COMMENT 'Long description (multilanguage)',
  `OXLONGDESC_1` varchar(2048) NOT NULL,
  `OXLONGDESC_2` varchar(2048) NOT NULL,
  `OXLONGDESC_3` varchar(2048) NOT NULL,
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`)
) ENGINE=MEMORY COMMENT 'Additional information for articles';
...
CREATE TABLE `oxattribute` (
  ...
  PRIMARY KEY  (`OXID`)
) ENGINE=MEMORY COMMENT 'Article attributes';
...
CREATE TABLE `oxcategory2attribute` (
  ...
  PRIMARY KEY  (`OXID`),
  KEY `OXOBJECTID` (`OXOBJECTID`)
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between categories and attributes';
...
CREATE TABLE `oxconfig` (
  ...
  `OXVARVALUE` varchar(2048) NOT NULL COMMENT 'Variable value',
  `OXTIMESTAMP`     timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`),
  KEY `OXVARNAME` (`OXVARNAME`),
  KEY `listall` (`OXSHOPID`, `OXMODULE`)
) ENGINE=MEMORY COMMENT 'Shop configuration values';
...
) ENGINE=MEMORY COMMENT 'Additional configuraion fields';
...
CREATE TABLE `oxcontents` (
  ...
  `OXTITLE` varchar(255) NOT NULL default '' COMMENT 'Title (multilanguage)',
  `OXCONTENT` varchar(2048) NOT NULL COMMENT 'Content (multilanguage)',
  `OXTITLE_1` varchar(255) NOT NULL default '' COMMENT '',
  `OXCONTENT_1` varchar(2048) NOT NULL,
  `OXACTIVE_2` tinyint(1) NOT NULL default '0' ,
  `OXTITLE_2` varchar(255) NOT NULL default '' ,
  `OXCONTENT_2` varchar(2048) NOT NULL ,
  `OXACTIVE_3` tinyint(1) NOT NULL default '0' ,
  `OXTITLE_3` varchar(255) NOT NULL default '' ,
  `OXCONTENT_3` varchar(2048) NOT NULL,
...
) ENGINE=MEMORY COMMENT 'Content pages (Snippets, Menu, Categories, Manual)';
...
CREATE TABLE `oxdel2delset` (
  ...
  PRIMARY KEY  (`OXID`),
  KEY `OXDELID` (`OXDELID`)
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between Shipping cost rules (oxdelivery) and delivery methods (oxdeliveryset)';
...
CREATE TABLE `oxdelivery` (
  ...
  PRIMARY KEY  (`OXID`),
  KEY `OXSHOPID` (`OXSHOPID`)
)  ENGINE=MEMORY COMMENT 'Delivery shipping cost rules';
...
CREATE TABLE `oxdeliveryset` (
  ...
  PRIMARY KEY  (`OXID`),
  KEY `OXSHOPID` (`OXSHOPID`)
) ENGINE=MEMORY COMMENT 'Delivery (shipping) methods';
...
CREATE TABLE IF NOT EXISTS `oxfiles` (
  ...
  PRIMARY KEY (`OXID`),
  KEY `OXARTID` (`OXARTID`)
) ENGINE=MEMORY COMMENT 'Files available for users to download';
...
CREATE TABLE `oxgroups` (
  ...
  PRIMARY KEY  (`OXID`),
  KEY `OXACTIVE` (`OXACTIVE`)
) ENGINE=MEMORY COMMENT 'User groups';
...
CREATE TABLE IF NOT EXISTS `oxinvitations` (
   ...
   `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
    KEY `OXUSERID` (`OXUSERID`),
    KEY `OXDATE` (`OXDATE`)
) ENGINE=MEMORY DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT 'User sent invitations';
...
CREATE TABLE `oxlinks` (
  ...
  `OXURLDESC` varchar(2048) NOT NULL COMMENT 'Description (multilanguage)',
  `OXURLDESC_1` varchar(2048) NOT NULL,
  `OXURLDESC_2` varchar(2048) NOT NULL,
  `OXURLDESC_3` varchar(2048) NOT NULL,
...
CREATE TABLE `oxmanufacturers` (
  ...
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`)
) ENGINE=MEMORY COMMENT 'Shop manufacturers';
...
CREATE TABLE `oxnews` (
  ...
  KEY `OXACTIVEFROM` (`OXACTIVEFROM`),
  KEY `OXACTIVETO` (`OXACTIVETO`)
) ENGINE=MEMORY COMMENT 'Shop news';
...
CREATE TABLE `oxnewsletter` (
  ...
  `OXTEMPLATE` varchar(4096) NOT NULL COMMENT 'HTML template',
  `OXPLAINTEMPLATE` varchar(4096) NOT NULL COMMENT 'Plain template',
  `OXSUBJECT` varchar(255) character set latin1 collate latin1_general_ci NOT NULL default '' COMMENT 'Subject',
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`)
) ENGINE=MEMORY COMMENT 'Templates for sending newsletters';
...
CREATE TABLE `oxnewssubscribed` (
  ...
  KEY `OXUSERID` (`OXUSERID`)
) ENGINE=MEMORY COMMENT 'User subscriptions';
...
) ENGINE=MEMORY DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT 'Shows many-to-many relationship between actions (oxactions) and objects (table set by oxclass)';
...
CREATE TABLE `oxobject2article` (
  ...
  KEY `OXARTICLENID` (`OXARTICLENID`),
  KEY `OXOBJECTID` (`OXOBJECTID`)
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between cross-selling articles';
...
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between articles and attributes';
...
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between delivery cost rules and objects (table determined by oxtype)';
...
CREATE TABLE `oxobject2list` (
  ...
  `OXDESC` varchar(2048) NOT NULL default '' COMMENT 'Description',
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`),
  KEY `OXOBJECTID` (`OXOBJECTID`),
  KEY `OXLISTID` (`OXLISTID`)
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between articles and listmania lists';
...
CREATE TABLE `oxobject2payment` (
  ...
  KEY ( `OXOBJECTID` ),
  KEY ( `OXPAYMENTID` )
) ENGINE=MEMORY COMMENT 'Shows many-to-many relationship between payments and objects (table determined by oxtype)';
...
CREATE TABLE `oxobject2seodata` (
  ...
  `OXKEYWORDS` varchar(2048) NOT NULL COMMENT 'Keywords',
  `OXDESCRIPTION` varchar(2048) NOT NULL COMMENT 'Description',
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
...
CREATE TABLE `oxorder` (
  ...
  `OXCARDTEXT` varchar(2048) NOT NULL COMMENT 'Gift card text',
  ...
  `OXREMARK` varchar(2048) NOT NULL COMMENT 'User remarks',
...
) ENGINE=MEMORY COMMENT 'Shop orders information';
...
CREATE TABLE `oxorderarticles` (
  ...
  `OXPERSPARAM` varchar(2048) NOT NULL COMMENT 'Serialized persistent parameters',
...
) ENGINE=MEMORY COMMENT 'Ordered articles information';
...
) ENGINE=MEMORY COMMENT 'Files, given to users to download after order';
...
CREATE TABLE `oxpayments` (
  ...
  `OXVALDESC` varchar(2048) NOT NULL COMMENT 'Payment additional fields, separated by "field1__@@field2" (multilanguage)',
  `OXCHECKED` tinyint(1) NOT NULL default '0' COMMENT 'Selected as the default method',
  `OXDESC_1` varchar(128) NOT NULL default '',
  `OXVALDESC_1` varchar(2048) NOT NULL,
  `OXDESC_2` varchar(128) NOT NULL default '',
  `OXVALDESC_2` varchar(2048) NOT NULL,
  `OXDESC_3` varchar(128) NOT NULL default '',
  `OXVALDESC_3` varchar(2048) NOT NULL,
  `OXLONGDESC` varchar(2048) NOT NULL default '' COMMENT 'Long description (multilanguage)',
  `OXLONGDESC_1` varchar(2048) NOT NULL default '',
  `OXLONGDESC_2` varchar(2048) NOT NULL default '',
  `OXLONGDESC_3` varchar(2048) NOT NULL default '',
  `OXSORT` int(5) NOT NULL default 0 COMMENT 'Sorting',
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`),
  KEY `OXACTIVE` (`OXACTIVE`)
) ENGINE=MEMORY COMMENT 'Payment methods';
...
CREATE TABLE `oxpricealarm` (
  ...
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY (`OXID`)
) ENGINE=MEMORY COMMENT 'Price fall alarm requests';
...
) ENGINE=MEMORY COMMENT 'Articles and Listmania ratings';
#
...
CREATE TABLE `oxrecommlists` (
  ...
  `OXTITLE` varchar(255) NOT NULL default '' COMMENT 'Title',
  `OXDESC` varchar(2048) NOT NULL COMMENT 'Description',
  `OXRATINGCNT` int(11) NOT NULL default '0' COMMENT 'Rating votes count',
  `OXRATING` double NOT NULL default '0' COMMENT 'Rating',
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`)
) ENGINE=MEMORY COMMENT 'Listmania';
...
CREATE TABLE `oxremark` (
  ...
  `OXTEXT` varchar(2048) NOT NULL COMMENT 'Remark text',
  `OXCREATE` datetime NOT NULL default '0000-00-00 00:00:00' COMMENT 'Creation time',
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`),
  KEY `OXPARENTID` (`OXPARENTID`),
  KEY `OXTYPE` (`OXTYPE`)
) ENGINE=MEMORY COMMENT 'User History';
...
CREATE TABLE `oxreviews` (
  ...
  `OXTEXT` varchar(2048) NOT NULL COMMENT 'Review text',
  `OXUSERID` char(32) character set latin1 collate latin1_general_ci NOT NULL default '' COMMENT 'User id (oxuser)',
  `OXCREATE` datetime NOT NULL default '0000-00-00 00:00:00' COMMENT 'Creation time',
  ...
  PRIMARY KEY  (`OXID`),
  KEY `oxobjectsearch` (`OXTYPE`,`OXOBJECTID`)
) ENGINE=MEMORY COMMENT 'Articles and Listmania reviews';
...
CREATE TABLE `oxselectlist` (
  ...
  `OXVALDESC` varchar(2048) NOT NULL COMMENT 'List fields, separated by "[field_name]!P![price]__@@[field_name]__@@" (multilanguage)',
  `OXTITLE_1` varchar(255) NOT NULL default '',
  `OXVALDESC_1` varchar(2048) NOT NULL,
  `OXTITLE_2` varchar(255) NOT NULL default '',
  `OXVALDESC_2` varchar(2048) NOT NULL,
...
) ENGINE=MEMORY COMMENT 'Seo urls information';
...
) ENGINE=MEMORY COMMENT 'Seo urls history. If url does not exists in oxseo, then checks here and redirects';
...
CREATE TABLE IF NOT EXISTS `oxseologs` (
  ...
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXIDENT`,`OXSHOPID`,`OXLANG`)
) ENGINE=MEMORY COMMENT 'Seo logging. Logs bad requests';
...
CREATE TABLE `oxshops` (
  ...
  PRIMARY KEY  (`OXID`),
  KEY `OXACTIVE` (`OXACTIVE`)
) ENGINE=MEMORY COMMENT 'Shop config';
...
) ENGINE=MEMORY COMMENT 'Module template blocks';
...
CREATE TABLE `oxuserbaskets` (
  ...
  KEY `OXTITLE` (`OXTITLE`),
  KEY `OXUSERID` (`OXUSERID`)
) ENGINE=MEMORY COMMENT 'Active User baskets';
...
CREATE TABLE `oxuserbasketitems` (
  ...
  KEY `OXARTID` (`OXARTID`)
) ENGINE=MEMORY COMMENT 'User basket items';
...
CREATE TABLE `oxuserpayments` (
  ...
  `OXVALUE` varchar(2048) NOT NULL COMMENT 'DYN payment values array as string',
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`),
  KEY `OXUSERID` (`OXUSERID`)
) ENGINE=MEMORY COMMENT 'User payments';
...
CREATE TABLE `oxvendor` (
  ...
  PRIMARY KEY  (`OXID`),
  KEY `OXACTIVE` (`OXACTIVE`)
) ENGINE=MEMORY COMMENT 'Distributors list';
...
CREATE TABLE `oxwrapping` (
  ...
  `OXTIMESTAMP` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Timestamp',
  PRIMARY KEY  (`OXID`)
) ENGINE=MEMORY COMMENT 'Wrappings';
